...
const Action = ({ 
  ...
  // Define which actions should show toggle
  const shouldShowToggle = useMemo(() => {
    const tabActions = [
      ...
      TOOL.Adaptive_question_generator,
    ...
    return tabActions.includes(type) && onToggleTab;
  }, [type, onToggleTab]);
      ...
      >
        ...
        {shouldShowToggle && (
          <button
            ...
            className={`flex items-center gap-1 px-2 py-1 rounded text-xs transition-colors ml-2 ${
              isTabVisible
