...
from deepsearcher.reasoning.config import ConfigConstants, get_config
from deepsearcher.reasoning.tools.base import BaseTool
from deepsearcher.reasoning.tools.registry import register_tool
from deepsearcher.reasoning.tools.tool_history import ToolHistory

# Import the original tool implementation
from deepsearcher.tool_clients.search_client import SearchClient
